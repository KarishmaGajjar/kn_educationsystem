    ...
    <div className='container'>
      <div className='row mt-5'>
        <div className='col-md-7 mt-5'>
          ...
          <button type="button" class="btn text-light" style={{backgroundColor:"#0056d2",borderColor:"#0056d2", width:"238px",height:"72px"}}>Join for free</button>&nbsp;&nbsp;&nbsp;
          <button type="button" class="btn" style={{borderWidth:"3px",borderColor:"#0056d2",color:"#0056d2",width:"320px",height:"72px"}} >Try Coursera for Bussiness</button>
        </div>
